...
3. Nếu deploy gây lỗi, rollback Worker version và static artifact trước. Không chạy migration phá hủy.
4. Nếu nghi lộ bí mật, thu hồi và xoay secret/token; kiểm tra audit log.
5. Nếu save lỗi, tạm dừng write nhưng giữ read; bảo toàn KV/D1 và local save.
